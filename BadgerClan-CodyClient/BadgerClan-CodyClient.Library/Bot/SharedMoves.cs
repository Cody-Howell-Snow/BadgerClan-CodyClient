...
public class SharedMoves
{
    ...
    public static Move StepToClosest(UnitDto unit, UnitDto closest, MoveRequest state)
    {
    ...
    public static Move StepAwayFromClosest(UnitDto unit, UnitDto closest, MoveRequest state) {
        Random rnd = new Random();
